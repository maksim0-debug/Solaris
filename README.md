...
- **Хранение данных**: JSON-хранилище на базе `shared_preferences` и `path_provider`.
...
1. Склонируйте репозиторий:
   ```bash
   git clone https://github.com/your-repo/solaris.git
   ```
...
## 📜 Лицензия
Этот проект является частным и предназначен для личного пользования. Подробности см. в `.metadata`.
