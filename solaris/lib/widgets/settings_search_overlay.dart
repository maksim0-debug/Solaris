...
class SettingsSearchOverlay extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SettingsSearchOverlay> createState() =>
      _SettingsSearchOverlayState();
}

class _SettingsSearchOverlayState extends ConsumerState<SettingsSearchOverlay>
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  _ShortcutKeyHint(
                                    label: 'Enter',
                                    description: l10n.selectMonitor,
                                  ),
                                  const SizedBox(width: 16),
                                  _ShortcutKeyHint(
                                    label: 'Esc',
                                    description: l10n.close,
                                  ),
                                ],
                              ),
                            ),
