...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get brightnessRegulationTitle => 'Регуляция яркости';
  ...
  String get sleepDataSubtitle =>
      'Добавьте постоянную сессию сна для регулировки яркости и температуры под ваш режим';
  ...
  String get circadianRegulationSubtitle =>
      'Приложение учитывает график сна для адаптации яркости и температуры под ваш режим. Все параметры настраиваются.';
  ...
  @override
  String get circadianRegulation => 'Связь со сном';
  ...
  String get serverPortSharedTooltip =>
      'Изменение этого порта также изменяет общий порт Solaris Control API в Настройках';
  ...
  String get sleepIntegrationHelpSectionConfigText =>
      '• Включите тумблер «Включить локальный API сервер».\n• Модульность и автономность: интеграция сна работает полностью независимо от Solaris Control API. Если основной API в Настройках выключен, API сна продолжит принимать данные.\n• Порт (по умолчанию 45321) является общим для сервера приложения: изменение номера порта здесь автоматически синхронизируется с Настройками.\n• Настройте ваше ПО для отправки POST-запросов на адреса:\n  - История сна: http://127.0.0.1:45321/api/sleep/sessions\n  - Статус реального времени: http://127.0.0.1:45321/api/sleep/status\n(Также поддерживаются префиксы /api/v1/sleep/...)';
  ...
  String get sleepIntegrationHelpSectionSecurityText =>
      'По умолчанию сервер работает исключительно на локальном адресе 127.0.0.1 и недоступен из внешней сети. Если в Настройках включен доступ по LAN (0.0.0.0), для передачи данных сна с других устройств обязательно требуется валидный API-токен с разрешением на операции со сном (push_sleep_status). Неавторизованный доступ из LAN строго блокируется кодом 401 Unauthorized.';
  ...
  String get updateIdlePrompt =>
      'Вы можете проверить наличие новых версий или загрузить релизы на GitHub.';
  ...
  String get appOverrideExitDelaySubtitle =>
      'Время в секундах до отключения профиля при сворачивании приложения.';
  ...
  @override
  String get userRulesSection => 'Пользовательские правила';

  @override
  String builtinRulesSection(int count) {
    return 'Встроенные пресеты ($count)';
  }

  @override
  String get addAppOverride => 'Добавить приложение';

  @override
  String get resetBuiltinRules => 'Сбросить системные правила';

  @override
  String get promoteToUser => 'Перенести в Мои';

  @override
  String get appOverrideModeGlobal => 'Глобальный';

  @override
  String get appOverrideModeFixed => 'Фиксированный';

  @override
  String get appOverrideModeCurve => 'Кривая';

  @override
  String get brightnessMode => 'Режим яркости';

  @override
  String get temperatureMode => 'Режим температуры';

  @override
  String get selectAppTitle => 'Выбор приложения';

  @override
  String get runningApps => 'Запущенные процессы';

  @override
  String get selectExecutable => 'Выбрать .exe файл...';

  @override
  String get customExeName => 'Имя исполняемого файла (например app.exe)';

  @override
  String get customDisplayName => 'Отображаемое имя';

  @override
  String appPromotedToast(String appName) {
    return 'Приложение $appName перенесено из встроенных пресетов в ваши правила';
  }

  @override
  String get resetBuiltinConfirmTitle => 'Сбросить системные правила?';

  @override
  String get resetBuiltinConfirmMessage =>
      'Вы уверены, что хотите восстановить фабричные значения встроенных пресетов? Ваши пользовательские правила сохранятся.';

  @override
  String get deleteOverrideConfirmTitle => 'Удалить правило?';

  @override
  String deleteOverrideConfirmMessage(String appName) {
    return 'Вы уверены, что хотите удалить правило для $appName?';
  }

  @override
  String get noRunningApps => 'Запущенные процессы не найдены';

  @override
  String get selectPreset => 'Выбрать пресет';
  ...
  @override
  String get softwareDimmingTitle => 'Глубокое затемнение (ниже 0%)';

  @override
  String get softwareDimmingSubtitle =>
      'Позволяет вручную снижать яркость ниже аппаратного минимума через оверлей';
