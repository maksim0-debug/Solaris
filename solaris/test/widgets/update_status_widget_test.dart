...
void main() {
  ...
  testWidgets('renders idle state with version info', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('renders available update state and opens dialog on tap', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'clicking Later closes available update dialog without resetting available state',
  ...
  testWidgets('renders downloading state with percentage', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      createTestableWidget(
  ...
  testWidgets('renders ready state and opens install dialog on tap', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      createTestableWidget(
        updateStatus: const UpdateStatus(phase: UpdatePhase.ready),
      ),
    );
  ...
  testWidgets('renders error state and opens error dialog on tap', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      createTestableWidget(
  ...
  testWidgets('renders checking state with spinner inside dialog', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      createTestableWidget(
        updateStatus: const UpdateStatus(phase: UpdatePhase.checking),
      ),
    );
  ...
  testWidgets('renders up to date notice when isUpToDateNotice is true', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      createTestableWidget(
