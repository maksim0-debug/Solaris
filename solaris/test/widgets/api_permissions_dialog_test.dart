...
void main() {
  ...
  group('Stage 4 GUI: ApiPermissionsDialog & ExpansionTile Accordion Tests', () {
    testWidgets('Renders all 7 category ExpansionTiles with Tri-State checkboxes', (WidgetTester tester) async {
    ...
    testWidgets('Expanding category tile shows granular action checkboxes and mono action keys', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      await tester.ensureVisible(find.text('Monitors (Brightness, Temp, Offsets)'));
    ...
    testWidgets('Toggling individual action updates state and returns updated ApiPermissionsConfig on Save', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      expect(resultConfig!.allowedActions!.contains('set_brightness'), isFalse);
      expect(resultConfig!.allowedActions!.contains('set_temperature'), isTrue);
