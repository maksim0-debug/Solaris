...
void main() {
  group('TemperatureService Reset Lock Tests', () {
    ...
    test(
      'lockTemperatureControl locks temperature service and sets 6500K',
      () async {
    ...
    test(
      'setTemperatureInstant ignores non-6500K target when reset lock is active',
      () async {
        final monitor = MonitorInfo(
          id: r'\\.\DISPLAY1\Monitor0',
          deviceName: 'DISPLAY1',
    ...
    test(
      'setTemperatureInstant dispatches native commands to ALL monitors when selection is all',
      () async {
