...
void main() {
  group('AppOverrideRule Phase 2 Data Model Zero-Trust Tests', () {
    test('defaultBuiltInRules returns 6 factory default 6500K color profile rules', () {
    ...
    test('exeName is automatically trimmed, lowercased, and stripped of directory paths', () {
    ...
    test('AppOverrideRule toJson and fromJson roundtrip works correctly across all modes', () {
    ...
    test('AppOverrideMode.fromJson handles unknown, null, or invalid string inputs gracefully', () {
      expect(AppOverrideMode.fromJson('fixed'), equals(AppOverrideMode.fixed));
      expect(AppOverrideMode.fromJson('curve'), equals(AppOverrideMode.curve));
      expect(AppOverrideMode.fromJson('global'), equals(AppOverrideMode.global));
      expect(AppOverrideMode.fromJson('invalid_mode'), equals(AppOverrideMode.global));
      expect(AppOverrideMode.fromJson(''), equals(AppOverrideMode.global));
    });

    test('AppOverrideRule.fromJson parses numeric strings and clamps out-of-bound or invalid values', () {
      final jsonExtreme = {
        'exeName': 'test.exe',
    ...
    test('copyWith normalizes exeName, clamps bounds, and respects clear flags', () {
    ...
    test('AppOverrideRule operator == and hashCode differentiate modified instances', () {
    ...
    test('AppOverrideMode enum serialization and case-insensitive deserialization works', () {
    ...
    test('AppOverrideRule.fromJson handles missing, non-string, or non-boolean json types gracefully', () {
    ...
    test('copyWith clamps out-of-bounds parameters and ignores NaN/Infinity', () {
      const rule = AppOverrideRule(
        exeName: 'game.exe',
        appDisplayName: 'Game',
    ...
    test('Verify all 6 default built-in rules conform strictly to design spec v10 section 3.2', () {
      ...
      expect(map['premiere.exe']?.appDisplayName, equals('Adobe Premiere Pro'));
  ...
  group('SettingsState Phase 2 Migration and Serialization Zero-Trust Tests', () {
    test('Legacy json without appOverrides key falls back to defaultBuiltInRules', () {
    ...
    test('Json with corrupted non-map appOverrides elements filters them safely without throwing', () {
    ...
    test('appOverrideExitDelaySeconds handles various input types and clamps to 0..300', () {
      final negativeDelayJson = <String, dynamic>{
        'appOverrideExitDelaySeconds': -50,
      };
      expect(SettingsState.fromJson(negativeDelayJson).appOverrideExitDelaySeconds, equals(0));

      final excessiveDelayJson = <String, dynamic>{
        'appOverrideExitDelaySeconds': 999,
      };
      expect(SettingsState.fromJson(excessiveDelayJson).appOverrideExitDelaySeconds, equals(300));

      final doubleDelayJson = <String, dynamic>{
        'appOverrideExitDelaySeconds': 60.0,
      };
      expect(SettingsState.fromJson(doubleDelayJson).appOverrideExitDelaySeconds, equals(60));

      final stringDelayJson = <String, dynamic>{
        'appOverrideExitDelaySeconds': '120',
      };
      expect(SettingsState.fromJson(stringDelayJson).appOverrideExitDelaySeconds, equals(120));

      final invalidStringDelayJson = <String, dynamic>{
        'appOverrideExitDelaySeconds': 'invalid_string',
      };
      expect(SettingsState.fromJson(invalidStringDelayJson).appOverrideExitDelaySeconds, equals(30));

      final boolDelayJson = <String, dynamic>{
        'appOverrideExitDelaySeconds': true,
      };
      expect(SettingsState.fromJson(boolDelayJson).appOverrideExitDelaySeconds, equals(30));
    });

    test('SettingsState toJson includes appOverrides and appOverrideExitDelaySeconds', () {
      ...
      final List<dynamic> overridesJson = json['appOverrides'] as List<dynamic>;
    ...
    test('SettingsState.copyWith updates appOverrides and appOverrideExitDelaySeconds correctly', () {
      final settings = SettingsState();
