...
class OverlayManager {
 public:
  ...
  // Sets the dimming overlay opacity for a specific monitor device path (e.g. \\.\DISPLAY1).
  // Opacity 0.0 hides the overlay. Values > 0.0 show a click-through transparent black window.
 ...
 private:
  ...
  std::mutex mutex_;
  std::unordered_map<std::string, OverlayInfo> overlays_;
